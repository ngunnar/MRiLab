function [GAmp, Gx, Gy, GTime, GTimeX, GTimeY] = Get_Rosette_Shared(p)
global VCtl;
global VObj;
global VVar;
...
peak_MAX = VCtl.MaxGrad;%VCtl.TargetPeakGradientLimit; % 10 mT/m = 10e-3 T/m
slew_MAX = VCtl.MaxSlewRate;%VCtl.PeakSlewRate; % 13mT/m/ms = 13 T/m/s
...
Gy = imag(GAmp);
Gx = real(GAmp);
[Gy, GTimeY] = Fix_slew_rate(Gy, GTime);
[Gx, GTimeX] = Fix_slew_rate(Gx, GTime);
end
