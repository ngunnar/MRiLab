function [GAmp, GTime] = Fix_slew_rate(GAmp, GTime)
    ...
    % Step 1: Create a ramp to the first value in the gradient if needed.
    ...
    % Step 2: If a ramp was created, compensate for the movement in
    % k-space by moving in the opposite direction. We place the movement
